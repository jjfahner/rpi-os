...
namespace UART {
	...
	kprintf("GPPUD:     %p\n", (void*)(arch_info->peripherals_base + GPPUD));
	kprintf("GPPUDCLK0: %p\n", (void*)(arch_info->peripherals_base + GPPUDCLK0));
	kprintf("UART0_DR:  %p\n", (void*)(arch_info->peripherals_base + UART0_DR));
	kprintf("UART0_FR:  %p\n", (void*)(arch_info->peripherals_base + UART0_FR));
